...
import com.androcoding.workoutapp.databinding.ItemExerciseStatusBinding
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        when{
            ...
            model.getIsCompleted()->{
                holder.tvItem.background=
                    ContextCompat.getDrawable(holder.itemView.context,R.drawable.item_circular_accent_background)
                holder.tvItem.setTextColor(Color.parseColor("#212121"))
            }else->{
            holder.tvItem.background=
